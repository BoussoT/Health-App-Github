...
def home():
    return jsonify({
        ...
        'description': 'This API allows you to calculate BMI (Body Mass Index) and BMR (Basal Metabolic Rate).',
        'endpoints': {
            '/bmi': 'POST request to calculate BMI (Provide height in meters and weight in kilograms)',
            '/bmr': 'POST request to calculate BMR (Provide height in centimeters, weight in kilograms, age in years, and gender as "male" or "female")'
        },
        'version': '1.0.0'
    })
